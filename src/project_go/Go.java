...
public class Go extends Application
{
	...
	private CustomControl cc_custom = new CustomControl(score1_lbl, score2_lbl);
	
	public void init()
	{
		items_name[0] = new Label("File");
		items_name[1] = new Label("Game");
		items_name[2] = new Label("Help");
		...
		items[2].setOnAction(new EventHandler<ActionEvent>() 
		{
		    ...
		    {
		    	 Label secondLabel = new Label("A game of Go starts with an empty board.\n"
		    	 ...
		    	 secondLabel.setPadding(new Insets(10, 0, 0, 0));
		...
		menu_lbl[2].getItems().add(items[2]);
		...
		score1_lbl.setStyle("-fx-font-size: 30 px");
		...
		score2_lbl.setStyle("-fx-font-size: 30 px");
